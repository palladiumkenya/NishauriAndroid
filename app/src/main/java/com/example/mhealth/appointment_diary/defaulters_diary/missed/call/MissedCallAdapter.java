...
//                                            }
                                    ...
                                    String sendSms = ccnumberS + "*" + sendapptype + "*" + new_appointment_type +"*"+nextappotherValue+ "*" + clientdatecalled + "*" + first_outcome_code + "*" + sendDate + "*" + getTracers + "*" + second_outcome_code + "*" + other+"*"+appointmentidS+"*"+clientreturndateS+"*"+Tracingcost;
