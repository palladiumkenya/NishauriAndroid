...
public class DefaulteredVisitModel {

    String ccnumber,thename,phone,apptype,date,read,patientid,fileserial,informantnumber,lastdateread,readcount;

    public DefaulteredVisitModel() {
    }

    public DefaulteredVisitModel(String ccnumber, String thename, String phone, String apptype, String date,String read,String patientid,String fileserial,String informantnumber,String lastdateread,String readcount) {
