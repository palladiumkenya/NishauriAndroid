...
public class LosttoFollowModel {

    String ccnumber,thename,phone,apptype,date,read,patientid,fileserial,informantnumber,lastdateread,readcount;

    public LosttoFollowModel() {
    }

    public LosttoFollowModel(String ccnumber, String thename, String phone, String apptype, String date, String read, String patientid, String fileserial, String informantnumber, String lastdateread, String readcount) {
