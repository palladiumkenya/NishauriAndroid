...
public class unrecognisedFragment extends Fragment {

    private RecyclerView recyclerView;
    private WellnesUnrecognisedAdapter adapter;
    private ArrayList<WellnessUnrecognisedModel> itemsList;
    CustomDialogs cd;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        v=inflater.inflate(R.layout.unrecognised_wellness_fragment,container,false);
        initialise();
        setListItems();
    ...
    public void initialise(){
        ...
        try{
            ...
            recyclerView = (RecyclerView) v.findViewById(R.id.unrecognised_wellnes_recyclerview);
    ...
    private void getMyWellnessData(){
        ...
        List<unrecognisedWellnessMessage> myl= unrecognisedWellnessMessage.findWithQuery(unrecognisedWellnessMessage.class,"select * from unrecognised_wellness_message where removed=?","false");
        for(int x=0;x<myl.size();x++){
            ...
            WellnessUnrecognisedModel cm=new WellnessUnrecognisedModel(mccn,mfname,mphone,mmsg,mmsgid);
            itemsList.add(cm);
    ...
    public void setMyAdapter(){
        ...
        try{
            ...
            adapter = new WellnesUnrecognisedAdapter(getActivity(), itemsList);
        }
        catch(Exception e){
        ...
        try{
            ...
            recyclerView.addOnItemTouchListener(new RecyclerTouchListener(getActivity(), recyclerView, new RecyclerTouchListener.ClickListener() {
                ...
                public void onClick(View view, int position) {
                    ...
                    WellnessUnrecognisedModel mitem=itemsList.get(position);

                    String msgid=mitem.getMsgid();
                    String phoneNo=mitem.getPhoneno();
                    cd.displayWellnessUnrecognisedEditDetails(msgid,phoneNo,itemsList,position,adapter);
