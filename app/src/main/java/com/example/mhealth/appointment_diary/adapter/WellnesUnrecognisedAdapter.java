...
public class WellnesUnrecognisedAdapter extends RecyclerView.Adapter<WellnesUnrecognisedAdapter.MyviewHolder> {

    List<WellnessUnrecognisedModel> mylist;
    Context ctx;

    public WellnesUnrecognisedAdapter(Context ctx, List<WellnessUnrecognisedModel> mylist) {
        this.mylist = mylist;
        this.ctx = ctx;
    }

    @Override
    public WellnesUnrecognisedAdapter.MyviewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    public void onBindViewHolder(MyviewHolder holder, int position) {
        try{
            ...
            WellnessUnrecognisedModel itm = mylist.get(position);
