...
//                        Log.e(TAG, response.toString());
                        ...
                        try {
                            ...
                            if (status){
                                ...
                                Intent intent1 =new Intent(oneActivity.this, LoginActivity.class);
                                ...
                                Toast.makeText(oneActivity.this, errors1, Toast.LENGTH_SHORT).show();
                    ...
                    public void onError(ANError error) {
                        Toast.makeText(oneActivity.this, error.getErrorDetail(), Toast.LENGTH_SHORT).show();

                        int  errors = error.getErrorCode();
                        if (errors==400){
                            Toast.makeText(oneActivity.this, "Invalid OTP Code", Toast.LENGTH_SHORT).show();
